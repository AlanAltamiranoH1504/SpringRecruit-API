...
public class SearchByFilterAndRecruiter extends IsJwtValidDTO {
    List<Long> contractTypes;
    List<Long> industriesSector;
    List<Long> worksModalities;
    List<Long> categories;

    public SearchByFilterAndRecruiter(List<Long> contractTypes, List<Long> industriesSector, List<Long> worksModalities, List<Long> categories) {
        super();
